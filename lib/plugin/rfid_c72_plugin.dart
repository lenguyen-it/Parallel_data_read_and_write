...
class RfidC72Plugin {
  ...
  static Future<bool?> get scanBarcodeSingle async {
    return _channel.invokeMethod('scanBarcodeSingle');
  }

  static Future<bool?> get scanBarcodeContinuous async {
    return _channel.invokeMethod('scanBarcodeContinuous');
  }

  static Future<bool?> get stopScanBarcode async {
    final bool? result = await _channel.invokeMethod('stopScanBarcode');
    return result;
  }
